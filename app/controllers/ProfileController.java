...
public class ProfileController extends Controller {
    ...
    public Result index() {
        ...
        return ok(index.render(emailForm, passwordForm, user.getApiToken(), ""));
    }
    ...
    public Result changeEmail() {
        ...
        if (emailForm.hasErrors()) {
            emailForm.data().put("email", user.getEmail());
            return badRequest(index.render(emailForm, formFactory.form(PasswordData.class), user.getApiToken(), ""));
        } else {
            ...
            return ok(index.render(emailForm, formFactory.form(PasswordData.class), user.getApiToken(), "Successfully changed Email"));
        }
    }
    ...
    public Result changePassword() {
        ...
        if (passwordForm.hasErrors()) {
            return badRequest(index.render(emailForm, passwordForm, user.getApiToken(), ""));
        } else {
            user.setPassword(passwordForm.get().getNewPassword1());
            Ebean.save(user);

            return ok(index.render(emailForm, formFactory.form(PasswordData.class), user.getApiToken(), "Successfully changed Password"));
        }
    }
    ...
    public Result changeToken() {
        ...
        user.setApiToken(PasswordHelper.generateToken());
        ...
        return ok(index.render(emailForm, passwordForm, user.getApiToken(), "Successfully generated new Api Token"));
    }
